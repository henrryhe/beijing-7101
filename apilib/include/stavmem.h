...
Description : Audio and video memory module header file
...
19 Aug 1999         Added OptimisedMemAccessStrategy_p in
                    InitParams for best methods settings             HG
 6 Oct 1999         Suppressed handles in mem access func
                    Suppressed Open/Close and introduce
                    partitions functions                             HG
13 Oct 1999         Added base addresses as init params              HG
 3 Jan 2000         Added 3 init params: video base addr,
                    SDRAM base addr and size.                        HG
10 Jan 2000         Added 2 init params: cached memory map           HG
02 Apr 2001         Added virtual mapping for shared memory
                    management.                                      HSdLM
01 Jun 2001         Add two error codes due to GPDMA copy method     HSdLM
                    introduction using STGPDMA library.
15 Mar 2002         Fix DDTS GNBvd10140 "Problems writing wrapper    HSdLM
 *                  around STAPI component headers"
20 Nov 2002         Add FDMA copy method                             HSdLM
28 Mar 2003         Multi-partitions support                         HSdLM
*******************************************************************************/
...
void *STAVMEM_UserToKernel( U32 VirtUserAddress ); /* defined in ustavmem.c  */
