...
Description : blitter module header file

COPYRIGHT (C) STMicroelectronics 2000.

Date               Modification                                     Name
----               ------------                                     ----
5 June 2000        Created                                          TM
29 May 2006        Modified for WinCE platform						WinCE Team-ST Noida
27 Sep 2006		   - Added STBLIT_ERROR_JOB_BLIT_DETACHED,			WinCE Team-ST Noida
                   - insert/delete an attached job blit, ...
                   - added declaration for all the new APIs.
...
#if !defined(ST_OS21) && !defined(ST_OSWINCE)  && !defined(STBLIT_LINUX_FULL_USER_VERSION)
	#include "stlite.h"
#endif
#include "stevt.h"
#include "stavmem.h"
