...
#define STE2P_ERROR_READ        ( STE2P_DRIVER_BASE )
#define STE2P_ERROR_WRITE       ( STE2P_DRIVER_BASE + 1 )
#define STE2P_ERROR_I2C         ( STE2P_DRIVER_BASE + 2 )
#define STE2P_ERROR_I2C_READ    ( STE2P_DRIVER_BASE + 3 )
#define STE2P_ERROR_I2C_WRITE   ( STE2P_DRIVER_BASE + 4 )
...
#define STE2P_SUPPORTED_DEVICE  0xA0    /* Supported Device Code */
#define ONE_K                   1024
