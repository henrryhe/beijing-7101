 ...
 * File Name   : stevt.h
 *
 * Description : Exported types and function for Event Handler driver
 *
...
/* STEVT Release Version*/
/*should be 30 chars long.
This is precisely this long:".............................."*/

#define STEVT_REVISION      "STEVT-REL_2.1.3             "
...
#define  STEVT_Notify(h,e,dp) STEVT_NotifyWithSize((h),(e),(dp),(dp)?sizeof(*dp):0)
...
#define  STEVT_NotifySubscriber(h,e,dp,s) STEVT_NotifySubscriberWithSize(h,e,dp,s,(dp)?sizeof(*dp):0)
