				       ...
				       EMBX_UINT intLevel)
{
	...
	res  = interrupt_install(intNumber, intLevel, interruptDispatcher, (void *) lms);
	res += interrupt_enable_number(intNumber);
	EMBX_Assert(0 == res);
#elif defined __OS21__
	...
	SetThreadPriority (lms->intThread, THREAD_PRIORITY_HIGHEST);
...
#if defined __ST20__ && defined __OS20__
		interrupt_disable_number(lms->intNumber);
		interrupt_uninstall(lms->intNumber, lms->intLevel);
#elif defined __OS21__
