...
#define MME_TYPE_SimpleParamsStatus_status2 char
};
...
/* INSbl23110 - pass significant sized params block in an attempt to detect leaks */
typedef MME_GENERIC64 SimpleParamsTransform_t[MME_LENGTH(SimpleParamsTransform) + (16*1024) ];
