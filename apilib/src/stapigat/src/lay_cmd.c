...
/* 7015, 7020 Variables ----------------------------------------------------- */
/*----12/18/2006 6:04PM----Added by RS for 7200 porting----*/
...
static BOOL LAYER_OpenViewPort (STTST_Parse_t *pars_p, char *result_sym_p)
{
 ...
 || defined (ST_5105) ||  defined (ST_5301) || defined (ST_5188)|| defined (ST_5525) || defined(ST_5107)
/*------- END -------*/
...
/*----12/18/2006 6:23PM----Added by RS for 7200 porting----*/
#if defined(ST_7015) || defined(ST_7020) || defined(ST_GX1) || defined(ST_5517)\
 || defined(ST_5516) || defined(ST_5528) || defined(ST_7710)  || defined(ST_7100) || defined(ST_7109)|| defined(ST_7200)|| defined(ST_5100)\
 || defined(ST_5516) || defined(ST_5528) || defined(ST_7710)  || defined(ST_7100) || defined(ST_7109)|| defined(ST_7200)|| defined(ST_5100)\
 || defined(ST_5105) || defined(ST_5301) || defined(ST_5188)|| defined(ST_5525) || defined(ST_5107)
    ...
    if ( RetErr )
    {
/*----12/18/2006 6:24PM----Added by RS for 7200 porting----*/
#if defined(ST_7015) || defined(ST_7020) || defined(ST_GX1) || defined(ST_5528) || defined(ST_7710) || defined(ST_7100)\
 ...
 || defined(ST_5517)
    ...
    if(Lvar ==2)
    {
/*----12/18/2006 6:33PM----Added by RS for 7200 porting----*/
#if defined(ST_7015) || defined(ST_7020) || defined(ST_GX1)  || defined(ST_5528) || defined(ST_7710) || defined(ST_7100)\
 || defined(ST_7109) || defined(ST_7200) || defined(ST_5100)|| defined(ST_5105) || defined(ST_5107) || defined(ST_5301) \
 || defined(ST_5188)|| defined(ST_5525)
 ...
 || defined(ST_5517)
    ...
    if(Lvar ==3)
    {
/*----12/18/2006 6:34PM----Added by RS for 7200 porting----*/
#if defined(ST_7015) || defined(ST_7020) || defined(ST_GX1)  || defined(ST_5528) || defined(ST_7710) || defined(ST_7100)\
 || defined(ST_7109) || defined(ST_7200) || defined(ST_5100) || defined(ST_5105)|| defined(ST_5107) || defined(ST_5301) \
 || defined(ST_5188)|| defined(ST_5525)
...
/*----12/18/2006 6:34PM----Added by RS for 7200 porting----*/
 ...
 || defined(ST_5188) || defined(ST_5525)
    ...
    if(Lvar ==5)
    {
/*----12/18/2006 6:35PM----Added by RS for 7200 porting----*/
#if defined(ST_7015) || defined(ST_7020) || defined(ST_GX1)  || defined(ST_5528) || defined (ST_7710) || defined (ST_7100)\
 || defined(ST_7109) || defined(ST_7200) || defined(ST_5100) || defined(ST_5105) || defined(ST_5107) || defined(ST_5301)\
 || defined(ST_5188) || defined(ST_5525)
    ...
    switch (BitmapUnknown.ColorType )
    {
        ...
        source.Data.BitMap_p = &BitmapUnknown;
