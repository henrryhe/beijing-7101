...
BOOL Init(U32 NumberOfPartitions)
{
    ...
    switch (NumberOfPartitions)
    {
        ...
        case 3 :
            ...
            PartitionMapTable[1].StartAddr_p = (void *) (PARTITION1_START);
            PartitionMapTable[1].StopAddr_p  = (void *) (PARTITION1_STOP);
            PartitionMapTable[2].StartAddr_p = (void *) (PARTITION2_START);     /* Non-secure partition starts here */
        ...
        case 4 :
            ...
            PartitionMapTable[1].StartAddr_p = (void *) (PARTITION1_START);
            PartitionMapTable[1].StopAddr_p  = (void *) (PARTITION1_STOP);
            PartitionMapTable[2].StartAddr_p = (void *) (PARTITION2_START);     /* LMI_SYS non-secure partition starts here */
            PartitionMapTable[2].StopAddr_p  = (void *) (PARTITION2_STOP);
            PartitionMapTable[3].StartAddr_p = (void *) (PARTITION3_START);     /* LMI_SYS secure partition starts here */
            PartitionMapTable[3].StopAddr_p  = (void *) (PARTITION3_STOP);
            break;
