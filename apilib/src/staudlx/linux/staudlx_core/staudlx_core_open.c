...
/*=============================================================================
  ...
  ===========================================================================*/
int staudlx_core_open(struct inode *node, struct file *filp)
{
 ...
 /* int major = imajor(node);         *//* The major number */
    ...
    if (NULL == filp->private_data) {
        ...
        /* staudlx_core_NewNode() may deshedule - call must be reentrant */
        filp->private_data = staudlx_core_NewNode(minor);
...
/*=============================================================================
   ...
   staudlx_core_release   (close)

   This function can deschedule and MUST be reentrant.

  ===========================================================================*/
int staudlx_core_release(struct inode *node, struct file *filp)  /* close */
{
...
static staudlx_core_dev_t *table[16];


/*=============================================================================

   staudlx_core_NewNode
  ...
  ===========================================================================*/
staudlx_core_dev_t *staudlx_core_NewNode(unsigned int id)
{
    /* Check valid id */
    ...
    down(&(staudlx_core_lock)); /* We can deshedule here !!! */
    ...
    if (NULL == table[id]) {
        ...
        table[id] = (staudlx_core_dev_t*)kmalloc(sizeof(staudlx_core_dev_t), GFP_KERNEL);
    ...
    up(&(staudlx_core_lock));  /* Release the global lock */
...
/*=============================================================================
   ...
   staudlx_core_GetNode

   Get an existing data structure for this 'device' (minor number)

  ===========================================================================*/
staudlx_core_dev_t *staudlx_core_GetNode(unsigned int id)
{
    /* Check valid id */
