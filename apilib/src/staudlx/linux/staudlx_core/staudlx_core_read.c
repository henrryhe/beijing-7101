...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t staudlx_core_read   (struct file *filp, char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;
...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t staudlx_core_write  (struct file *filp, const char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;
...
/*=============================================================================
   ...
   in the template driver and staudlx_core_lseek should not be added to the fops.
   
  ===========================================================================*/
int staudlx_core_flush  (struct file *filp)
{
    return (0);
}
...
/*=============================================================================
  ...
  ===========================================================================*/
loff_t  staudlx_core_lseek  (struct file *filp,  loff_t offset, int other)
{   
    return (-ENOTTY);
}
 ...
 * These methods are called from staudlx_core_read() and staudlx_core_write()
