...
#ifndef STAUDLX_IOCTL_TYPES_H
#define STAUDLX_IOCTL_TYPES_H
...
extern struct semaphore staudlx_ioctl_lock; /* Global lock for the module */

staudlx_ioctl_dev_t *staudlx_ioctl_NewNode(unsigned int minor);
staudlx_ioctl_dev_t *staudlx_ioctl_GetNode(unsigned int minor);
void              staudlx_ioctl_CleanUp(void);
