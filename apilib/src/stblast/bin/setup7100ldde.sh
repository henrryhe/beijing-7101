...
setenv  KDIR /opt/STM/STLinux-2.2/devkit/sources/kernel/linux-2.6.17.14_stm22_0036
...
setenv DVD_CFLAGS '-DST_OSLINUX -DARCHITECTURE_ST40 -DST_LINUX  -DDISABLE_TBX -DNO_STAPIGAT -DSTTBX_NO_UART  -DSTBLAST_NOT_USE_IRB_JACK'

#setenv DVD_BUILDING_IN_VOB true

# MULTICOM specific
setenv MULTICOM 1
setenv  LSPROOT /opt/STM/STLinux-2.2/devkit/sources/kernel/linux-2.6.17.14_stm22_0036/
