...
----               ------------                 ----
Jan 2000           Created for the 5508			FP
*******************************************************************************/
...
#define CKG_VER               0x00 /* Clock generator version */
#define CKG_RLOCK             0xCF /* Clock lock configuration */
#define CKG_AUD1              0xD0 /* Audio clock controller register */
#define CKG_AUD0              0xD1 /* Audio clock divider register */
#define CKG_MCK1              0xD4 /* Memory clock controller register */
#define CKG_MCK0              0xD5 /* Memory clock divider register */
#define CKG_KARA1             0xDA /* Karaoke clock controller register */
#define CKG_KARA0             0xDB /* Karaoke clock divider register */
#define CKG_DENC1             0xDC /* Denc clock controller register */
#define CKG_ST20_FEI_LINK1    0xDD /* ST20/FEI/LINK clock controller register */
#define CKG_ST20_FEI_LINK0    0xDE /* ST20/FEI/LINK divider register */
#define CKG_PLL3              0xDF /* M = Pre divider ratio setup of the PLL */
#define CKG_PLL2              0xE0 /* N = Feed back divider ratio setup of the PLL */
#define CKG_PLL1              0xE1 /* bits[7:5] : P = Post divider ratio setup of the PLL
                                      bits[4:2] : lock detector threshold */
#define CKG_PLL0              0xE2 /* bits[7:6] : Start up control
                                      bits[5:2] : Charge pump control */
#define CKG_CFG               0xE3 /* Clocks generator configuration of clock pins */
