...
Description : CACHE registers for 5508
...
History     :
    ...
    16/02/01  Updated according to Rev B of register manual.
 ...
 *
 * IMPORTANT NOTE:  The 5508 cache control for REGION 1 allows
