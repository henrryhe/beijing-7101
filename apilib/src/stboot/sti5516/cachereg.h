...
Description : CACHE registers for 5514
...
#define DCAC_Region0Enable       (0x1000 + 0x020)
#define DCAC_Region1BlockEnable  (0x1000 + 0x028)
#define DCAC_Region1TopEnable    (0x1000 + 0x02C)
#define DCAC_Region2Enable       (0x1000 + 0x030)
#define DCAC_Region3BlockEnable  (0x1000 + 0x038)
#define DCAC_Region3BankEnable   (0x1000 + 0x03C)

#define ICAC_Region0Enable       0x020
#define ICAC_Region1BlockEnable  0x028
#define ICAC_Region1TopEnable    0x02C
#define ICAC_Region2Enable       0x030
#define ICAC_Region3BlockEnable  0x038
#define ICAC_Region3BankEnable   0x03C

/* Global cache registers */
#define ENABLE_ICACHE           0x000
#define INVALIDATE_ICACHE       0x010

#define ENABLE_DCACHE           (0x1000 + 0x000)
#define INVALIDATE_DCACHE       (0x1000 + 0x010)
#define FLUSH_DCACHE            (0x1000 + 0x014)
#define CACHE_STATUS            (0x1000 + 0x018)
#define DCACHE_NOT_SRAM         ENABLE_DCACHE

#define ICACHE_CONTROL_LOCK      0x04
#define DCACHE_CONTROL_LOCK      (0x1000 + 0x004)
