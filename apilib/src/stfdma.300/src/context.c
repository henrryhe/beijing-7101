...
typedef volatile struct SCCtrl_s
{
    ...
    U32 Pad             : 12;
    U32 SCDModeSelect   :  1;
#elif defined (ST_7109) || defined (ST_7200) || defined (ST_7111) || defined (ST_7105)
    U32 Pad             : 11;
    U32 SCDModeSelect   :  2;
#else
    U32 Pad             : 13;
...
#if defined (ST_7100) || defined (ST_7109) || defined (ST_7200) || defined (ST_7111) || defined (ST_5525) || defined (ST_5162) || defined (ST_7105)
    U32 Pad1[16];
#endif
}ContextLayout_t;
...
#else
static int            SemaSet[STFDMA_MAX] = {FALSE};
static ContextLayout_t *ContextLayout[STFDMA_MAX] = {NULL};
#endif
...
#if !(defined(ST_5517) || defined(ST_498))
    U16 Context = 0;
    int i;
#endif
...
#endif
        {       
           STSYS_WriteRegDev32LE(((void*)((U8*)(ContextLayout[STFDMA_PES]+Context) + (i * sizeof(U32)))), (0));
        }
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    *SCList    = (STFDMA_SCEntry_t*)(STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].SCWrite))) &  ~0X0F);
    *Size      = STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].SCSize)));
    *Overflow  = (STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].SCWrite))) & 0X01);
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].SCWrite)),(((U32)(SCList)) & ~0X0F));
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].SCSize)),(Size & ~0X0F));
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
	                                     ...
	                                     STFDMA_SCRange_t    Range)
{
    ...
    switch (Range)
    {
        case STFDMA_DEVICE_PES_RANGE_0 :
            ...
            *(U32 *)((void *) &PESControl) =STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].PES0)));
...
#endif
            State->PTSEnabled     = 0;
             *(U32 *)((void *) &SCControl) = STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ES0)));
        ...
        case STFDMA_DEVICE_ES_RANGE_1 :
            State->PTSEnabled     = 0;
            *(U32 *)((void *) &SCControl) = STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ES1)));
            State->RangeStart     = SCControl.Start;
            State->RangeEnd       = SCControl.End;
            State->OneShotEnabled = SCControl.PTS_OneShot;
            State->RangeEnabled   = SCControl.Enable;
	                                     ...
	                                     STFDMA_SCRange_t    Range)
{
    ...
    switch (Range)
    {
        case STFDMA_DEVICE_PES_RANGE_0 :
            ...
            STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].PES0)), ((U32)*(U32 *)((void *) &PESControl)));
            break;
        ...
        case STFDMA_DEVICE_ES_RANGE_0 :
            ...
            SCControl.InNotOut      = InRange;
             STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ES0)), ((U32)*(U32 *)((void *) &SCControl)));
            break;
...
/* Due to specific bit positions of the 'mode' field the following difference is not apparent for ST_OSLINUX */
        ...
        case STFDMA_DEVICE_ES_RANGE_1 :
            ...
            SCControl.SCDModeSelect = 0;
#endif
            STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ES1)),((U32)*(U32 *)((void *) &SCControl)));
            break;
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESTop)),(((U32)Buffer + Size) & ~0X7F));
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESRead)),((U32)Buffer));
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESWrite)),((U32)Buffer));
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESBottom)),(((U32)Buffer) & ~0X7F));
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESRead)),((U32)Read));
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    STSYS_WriteRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESWrite)),((U32)Write));
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    *Read = (void *)STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESRead)));
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
#else
    STOS_SemaphoreWait(APILockSem[STFDMA_PES]);
    *Write = (void*)(STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESWrite)))  & ~0x03);
    if (NULL != Overflow) *Overflow = (STSYS_ReadRegDev32LE(((void*)&(ContextLayout[STFDMA_PES][Context].ESWrite))) & 0x01);
    STOS_SemaphoreSignal(APILockSem[STFDMA_PES]);
#endif
...
void stfdma_InitContexts(U32 *BaseAddress_p, ST_Partition_t  *DriverPartition_p, STFDMA_Block_t DeviceNo)
{
    ...
    if (!SemaSet[DeviceNo])
    {
        APILockSem[DeviceNo] = STOS_SemaphoreCreateFifo(DriverPartition_p,  1);
...
int stfdma_TermContexts(STFDMA_Block_t DeviceNo, ST_Partition_t  *DriverPartition_p)
{
    ...
    STOS_SemaphoreDelete(DriverPartition_p,  APILockSem[DeviceNo]);
                                             ...
                                             STFDMA_ContextId_t         ContextId)
{
    ...
    {
       STSYS_WriteRegDev32LE(((void*)((U8*)(ContextLayout[STFDMA_PES]+Context) + (i * sizeof(U32)))),(VirtualContextLayout_p32[i]));
    }
...
#endif /* ST_7100 || ST_7109) || ST_5525 */
    {
        VirtualContextLayout_p32[i] = (U32)(STSYS_ReadRegDev32LE(((void*)((U8*)(ContextLayout[STFDMA_PES]+Context) + (i * sizeof(U32))))));
    }
