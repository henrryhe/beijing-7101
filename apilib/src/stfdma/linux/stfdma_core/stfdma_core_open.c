...
/*=============================================================================
  ...
  ===========================================================================*/
int fdma_open(struct inode *node, struct file *filp)
{
 ...
 /* int major = imajor(node);         *//* The major number */
    ...
    if (NULL == filp->private_data) {
        ...
        /* fdma_NewNode() may deshedule - call must be reentrant */
        filp->private_data = fdma_NewNode(minor);
...
/*=============================================================================
  ...
  ===========================================================================*/
int fdma_release(struct inode *node, struct file *filp)  /* close */
{
...
/*=============================================================================
  ...
  ===========================================================================*/
fdma_dev_t *fdma_NewNode(unsigned int id)
{
    /* Check valid id */
    ...
    down(&(fdma_lock)); /* We can deshedule here !!! */
    ...
    if (NULL == table[id]) {
        ...
        table[id] = (fdma_dev_t*)kmalloc(sizeof(fdma_dev_t), GFP_KERNEL);
    ...
    up(&(fdma_lock));  /* Release the global lock */
...
/*=============================================================================
  ...
  ===========================================================================*/
fdma_dev_t *fdma_GetNode(unsigned int id)
{
    /* Check valid id */
