...
#ifndef FDMATEST_TYPES_H
#define FDMATEST_TYPES_H
...
extern struct semaphore fdmatest_lock; /* Global lock for the module */

fdmatest_dev_t *fdmatest_NewNode(unsigned int minor);
fdmatest_dev_t *fdmatest_GetNode(unsigned int minor);
void              fdmatest_CleanUp(void);
