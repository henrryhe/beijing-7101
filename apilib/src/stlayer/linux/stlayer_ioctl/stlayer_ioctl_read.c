...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t stlayer_ioctl_read   (struct file *filp, char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;

    stlayer_ioctl_dev_t *dev_p = (stlayer_ioctl_dev_t*)filp->private_data;
...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t stlayer_ioctl_write  (struct file *filp, const char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;
...
/*=============================================================================
   ...
   in the template driver and stlayer_ioctl_lseek should not be added to the fops.

  ===========================================================================*/
int stlayer_ioctl_flush  (struct file *filp)
{
    return (0);
}
...
/*=============================================================================
  ...
  ===========================================================================*/
loff_t  stlayer_ioctl_lseek  (struct file *filp,  loff_t offset, int other)
{
    return (-ENOTTY);
}
 ...
 * These methods are called from stlayer_ioctl_read() and stlayer_ioctl_write()
