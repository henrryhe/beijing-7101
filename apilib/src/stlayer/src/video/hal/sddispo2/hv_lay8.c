...
#else
    /* STFAE - START - GNBvd68888 - O.Lorente - For aux display take into source horizontal position */
    U32                             SourcePositionLumaHorizontal;
    U32                             SourcePositionChromaHorizontal;
    U32                             SourcePositionLumaVerticalTop;
    U32                             SourcePositionLumaVerticalBottom;
    U32                             SourcePositionChromaVerticalTop;
    U32                             SourcePositionChromaVerticalBottom;
    /* STFAE - STOP  - GNBvd68888 - O.Lorente - For aux display take into source horizontal position */
...
#endif /* defined(HAL_VIDEO_LAYER_FILTER_DISABLE) */
    {
             ...
             (FiltersNeedReload)  )
        {
            ...
            stlayer_WriteHorizontalFilterCoefficientsToMemory(
                   ...
                   /* HorizontalLumaFilter zxg 20091015 change*/HorizontalChromaFilter);
#endif /* !defined(DVD_SECURED_CHIP) */
...
#define USE_LITTLEENDIAN
    ...
    {
        /* Progressive Source: We always read the whole Frame */
        SourcePositionLumaVerticalTop = InputRectangle.PositionY/16;
        SourcePositionChromaVerticalTop = (InputRectangle.PositionY/16) >> (LayerCommonData_p->SourceFormatInfo.IsFormat422Not420 ? 0 : 1);
        /* No Bottom Field so we copy the same thing than for the Top */
        SourcePositionLumaVerticalBottom = SourcePositionLumaVerticalTop;
        SourcePositionChromaVerticalBottom = SourcePositionChromaVerticalTop;
    }
    else
    {
        /* Interlaced Source */
        SourcePositionLumaVerticalTop = InputRectangle.PositionY/16;
        SourcePositionChromaVerticalTop = (InputRectangle.PositionY/16) >> (LayerCommonData_p->SourceFormatInfo.IsFormat422Not420 ? 0 : 1);
        SourcePositionLumaVerticalBottom = SourcePositionLumaVerticalTop + 1;
        SourcePositionChromaVerticalBottom = SourcePositionChromaVerticalTop + 1;
    }

    /* Horizontal positioning is the same in 4:2:0 and 4:2:2 */
    SourcePositionLumaHorizontal = InputRectangle.PositionX / 16;
    SourcePositionChromaHorizontal = (InputRectangle.PositionX / 16) >> 1;

    /* LUMA_XY and CHR_XY refers to the field sent to the display so they are independant from DisplayTopRegister and DisplayBottomRegister */
    if (LayerCommonData_p->ViewPortParams.Source_p->Data.VideoStream_p->CurrentField.FieldType == STLAYER_TOP_FIELD)
    {
        HAL_WriteDisp32(DISP_LUMA_XY, (SourcePositionLumaVerticalTop << 16) + SourcePositionLumaHorizontal);
        HAL_WriteDisp32(DISP_CHR_XY, (SourcePositionChromaVerticalTop << 16) + SourcePositionChromaHorizontal);
    }
    else
    {
        HAL_WriteDisp32(DISP_LUMA_XY, (SourcePositionLumaVerticalBottom << 16) + SourcePositionLumaHorizontal);
        HAL_WriteDisp32(DISP_CHR_XY, (SourcePositionChromaVerticalBottom << 16) + SourcePositionChromaHorizontal);
    }
    /* STFAE - STOP  - GNBvd68888 - O.Lorente - For aux display take into source horizontal position */
#endif /* STAPIREF_COMPAT */
