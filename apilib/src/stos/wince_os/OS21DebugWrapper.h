/* Wrapper from OS20/OS21 debug functions (os21debug.h) to WINCE */

#ifndef __OS21DebugWrapper_h
#define __OS21DebugWrapper_h
...
// already defined in os21debug.h
#if 1
...
#define DEBUG_NOT_CONNECTED 0 //WHE defined in os21debug.h
