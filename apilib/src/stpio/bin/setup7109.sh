...
setenv PATH /home/abhargva/newmake/:/opt/STM/STLinux-2.2/devkit/sh4/bin:$PATH
...
setenv  KDIR /opt/STM/STLinux-2.2/devkit/sources/kernel/linux-2.6.17.14_stm22_0036_7109_mb411
...
setenv DVD_CFLAGS '-DST_OSLINUX -DARCHITECTURE_ST40 -DST_LINUX  -DDISABLE_TBX -DNO_STAPIGAT -DSTTBX_NO_UART'

#setenv DVD_BUILDING_IN_VOB true

# MULTICOM specific
setenv MULTICOM 1
setenv  LSPROOT /opt/STM/STLinux-2.2/devkit/sources/kernel/linux-2.6.17.14_stm22_0036_7109_mb411/
