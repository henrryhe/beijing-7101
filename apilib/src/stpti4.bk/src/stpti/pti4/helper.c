...
extern STFDMA_Node_t *FDMANode_p;
...
{
    return( (void *)(((U32) Base_p + 0xf) & (~0xf)) );
}
...
static U32 FDMATransfer(U8 *Dest, U8 *Src, U32 CopySize, FullHandle_t FullBufferHandle)
{
    ...
    FDMANode_p->NumberBytes = CopySize;
    FDMANode_p->SourceAddress_p = (void*) ((U32)TRANSLATE_PHYS_ADD(Src));
    FDMANode_p->DestinationAddress_p = (void*)((U32)TRANSLATE_PHYS_ADD(Dest));    
    FDMANode_p->Length = CopySize;
...
static U32 DMATransfer(U8 *Dest, U8 *Src, U32 CopySize, TCDevice_t *TC_Device_p, U32 DirectDma, STPTI_TCParameters_t *TC_Params_p)
{
    ...
    Source_PAddr      = (U32)TRANSLATE_PHYS_ADD(Src);              /* Source Start */
    Write             = (U32)TRANSLATE_PHYS_ADD(Src+CopySize);     /* Source End */
    Destination_PAddr = (U32)TRANSLATE_PHYS_ADD(Dest);             /* Destination */
