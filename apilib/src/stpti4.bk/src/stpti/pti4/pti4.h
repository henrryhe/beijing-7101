...
#define TC_GLOBAL_DATA_WILDCARD_PID_SET                        0x0002
...
#define TC_SESSION_INFO_DMA_DISABLE_SET                        0x0004
...
#define TCKEY_CHAIN_MODE_SYN       0x0004
...
#define STATUS_FLAGS_ARRIVAL_TIME_VAILD_FLAG      0x80000000
...
{
    U16 SCD_SlotState;
    U16 SCD_padding;            /* make sure host writable side is 4 byte aligned */
    U16 SCD_SlotStartCode;      /* host writable B7:0 StartCodeByte, B15 =0 MPEG2, =1 H264 */
    U16 SCD_SlotMask;           /* host writable */
} TCSCDFilterEntry_t;
