...
/* ------------------------- 
           Status: CONVERTED
    Referenced by: STPTI_Init for HAL 1, n/a for HAL 3 & 4
              HAL: 1 3 4
      description: Print out current TC application status
   previous alias: ...DumpStatus
   ------------------------- */
void stptiHAL_DebugDumpStatus(FullHandle_t DeviceHandle);
#endif  /* STPTI_DEBUG */

#ifdef STPTI_DEBUG_SUPPORT
/* ------------------------- 
           Status: NOT YET IMPLEMENTED, NEW FUNCTIONALITY
    Referenced by: STPTI_DebugGetTCRegisters
              HAL: 4
      description: This function can be used to assess if the TC is locked in an infinite loop. 
                   The use of DeviceName is admittedly pointless, but it does help to maintain STAPI conformance.
...
/* ------------------------- 
           Status: NOT YET IMPLEMENTED, NEW FUNCTIONALITY
    Referenced by: STPTI_DebugGetTCDRAM        
              HAL: 4
      description: This function is the standard TC ram dump.
   previous alias: ...
   ------------------------- */
...
/* DMA History
    ...
    This functionality permits the user to gain access to information about the
   last N DMA writes (specified by the size parameter which must be <= 10).The table is an array passed in by the user.

*/

/* ------------------------- 
           Status: NOT YET IMPLEMENTED, NEW FUNCTIONALITY
    Referenced by: STPTI_DebugGetDMAHistory    
              HAL: 4
      description: DMA History
   previous alias: ...
   ------------------------- */
...
/* ------------------------- 
           Status: NOT YET IMPLEMENTED, NEW FUNCTIONALITY
    Referenced by: STPTI_DebugGetTCStatus    
              HAL: 4
