...
#else
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5200) || defined(ST_5300) || defined(ST_5301) || defined(ST_7710) || defined(ST_7100)
...
#if defined(ST_5528) || defined(ST_5100) || defined(ST_5101) || defined(ST_5200) ||     defined(ST_5300) || defined(ST_5301) || defined(ST_7710) || defined(ST_7100) ||     defined(ST_5202) || defined(ST_7101) || defined(ST_7105) || defined(ST_7109) ||     defined(ST_7111) || defined(ST_7141)
...
*/
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5200) || defined(ST_5300) || defined(ST_5301) || defined(ST_7710) || defined(ST_7100) || defined(ST_7120)

    #define STPTI_CORE_COUNT    1

#else
#if defined(ST_5528) || defined(ST_5202) || defined(ST_7101) || defined(ST_7105) || defined(ST_7109) || defined(ST_7111) || defined(ST_7141) || defined(ST_7200)
...
*/
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5200) || defined(ST_5202) || defined(ST_5300) || defined(ST_5301) ||     defined(ST_7100) || defined(ST_7101) || defined(ST_7105) || defined(ST_7109) || defined(ST_7111) || defined(ST_7141) ||     defined(ST_7200) || defined(ST_7710)
...
#define STPTI_REVISION      "STPTI_DVB-REL_6.7.0           "
...
typedef enum STPTI_DescramblerType_s
{
    ...
    ,
    STPTI_DESCRAMBLER_TYPE_AES_SYN_DESCRAMBLER,
...
#if defined(ST_7101) || defined(ST_7109)
    STPTI_STREAM_ID_SWTS0,
    STPTI_STREAM_ID_SWTS1,
    STPTI_STREAM_ID_SWTS2,
#endif
...
#define STPTI_SWTS_MAX_RATE  (20000000)
...
/* PTI4 Architectures (Arch) for each st device...
     ...
     PTI4L   TSMRG  is for... 5100, 5101, 5200, 5300, 5301, 7100, 7710
...
ID  Loader_function         file             Arch    TSMUX  Description
 ...
 2  STPTI_DVBTCLoaderKTL    DVB_LdrKTL.c     PTI4L   TSMRG  DVB 3 vPTI loader with Synamedia AES (7100 and PES only)
