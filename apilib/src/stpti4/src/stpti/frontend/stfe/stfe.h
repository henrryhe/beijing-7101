...
/* Exported Constants -------------------------------------------------- */
#define STFE_BASE_ADDRESS                     (STPTI_Driver.STFE_Base_Address)
#define STFE_REGION_SIZE                      (0x1000)
#define STFE_INTERNAL_RAM_BASE_ADDRESS        (STPTI_Driver.STFE_Internal_RAM_Base_Address)
