...
ST_ErrorCode_t STPTI_CarouselAllocate(STPTI_Handle_t Handle, STPTI_Carousel_t * Carousel)
{
    ...
    STTBX_Print(("STPTI_CarouselAllocate: HANDLE 0x%08x\n", (U32) Handle ));
    ...
    if (Error == ST_NO_ERROR)
    {
        ...
        else
        {
            ...
            {
                memset ((void*)&TmpCarousel, 0, sizeof (Carousel_t));
                ...
                *Carousel = FullCarouselHandle.word; /* Carousel Handle to be returned */
                ...
                STTBX_Print(("STPTI_CarouselAllocate: CAROUSEL HANDLE ALLOCATED 0x%08x\n", (U32) *Carousel ));
...

                {
                    ...
                    if( Error == ST_NO_ERROR )
                    {
                        ...
                        STTBX_Print(("STPTI_CarouselAllocate: CAROUSEL TASK CREATED 0x%08x\n", (U32) CarouselTaskID ));
...
ST_ErrorCode_t STPTI_CarouselLinkToBuffer(STPTI_Carousel_t CarouselHandle, STPTI_Buffer_t BufferHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselLinkToBuffer: CAROUSEL HANDLE 0x%08x BUFFER HANDLE 0x%08x\n", (U32) CarouselHandle, (U32)BufferHandle ));
...
ST_ErrorCode_t stpti_DeallocateCarousel(FullHandle_t CarouselHandle, BOOL Force)
{
    ...
    STTBX_Print(("stpti_DeallocateCarousel: CAROUSEL HANDLE 0x%08x Force 0x%1x\n", (U32) CarouselHandle.word, (U32)Force ));
    ...
    /* Wait for Carousel Task to complete */
    ...
    if (Error == ST_NO_ERROR)
    {
        ...
        if (Sem_p != NULL)
        {
            Error = STOS_SemaphoreDelete(NULL, Sem_p);    /* destroy signalling semaphore */
        }

        if (Error == ST_NO_ERROR)    /* moved down, so that we ensure carousel currently not in the mid of dealing an entry */
        {        
...
ST_ErrorCode_t stpti_DeallocateCarouselEntry(FullHandle_t EntryHandle, BOOL Force)
{
    ...
    STTBX_Print(("stpti_DeallocateCarouselEntry: CAROUSEL ENTRY HANDLE 0x%08x Force 0x%1x\n", (U32) EntryHandle.word, (U32)Force ));
...
ST_ErrorCode_t STPTI_CarouselEntryAllocate(STPTI_Handle_t Handle, STPTI_CarouselEntry_t *CarouselEntryHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselEntryAllocate: STPTI HANDLE 0x%08x\n", (U32) Handle ));
    ...
    if (Error == ST_NO_ERROR)
    {
        if (stptiMemGet_Device(FullSessionHandle)->EntryType == STPTI_CAROUSEL_ENTRY_TYPE_SIMPLE)
        {
            ...
            if (Error == ST_NO_ERROR)
            {
                ...
                memset ((void*)&TmpCarouselEntry, 0, sizeof (CarouselSimpleEntry_t));
                ...
                *CarouselEntryHandle = FullCarouselEntryHandle.word;
                STTBX_Print(("STPTI_CarouselEntryAllocate: SIMPLE ENTRY HANDLE ALLOCATED 0x%08x\n", (U32) *CarouselEntryHandle ));
            }
        }
        else    /* STPTI_CAROUSEL_ENTRY_TYPE_TIMED */
        {
            ...
            if (Error == ST_NO_ERROR)
            {
                ...
                memset ((void*)&TmpCarouselEntry, 0, sizeof (CarouselTimedEntry_t));
                ...
                *CarouselEntryHandle = FullCarouselEntryHandle.word;
                STTBX_Print(("STPTI_CarouselEntryAllocate: TIMED ENTRY HANDLE ALLOCATED 0x%08x\n", (U32) *CarouselEntryHandle ));
            }
        }
    }
                                         ...
                                         STPTI_InjectionType_t InjectionType, STPTI_CarouselEntry_t Entry)
{
    ...
    BOOL          SignalCarouselTask = FALSE;

    STTBX_Print(("STPTI_CarouselInsertEntrys: CAROUSEL HANDLE 0x%08x ALTOUTTAG 0x%08x INJTYPE 0x%08x CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselHandle,(U32)AlternateOutputTag,(U32)InjectionType, (U32)Entry ));
        ...
        if (LockingSession.word == STPTI_NullHandle() || LockingSession.word == CarouselHandle)
        {
            ...
            if (Error == ST_NO_ERROR)
            {
                ...
                if (Error == ST_NO_ERROR)
                {
                    ...
                    if (Error == ST_NO_ERROR && SignalCarouselTask == TRUE)
                    {
                        /* Signal only on first entry insertion */
                        STTBX_Print (("\nSignaling CarouselTask (from STPTI_CarouselInsertEntry)\n"));
                        STOS_SemaphoreSignal (stptiMemGet_Carousel(FullCarouselHandle)->Sem_p);
                    }
                }
            }
        }
                                              ...
                                              U32 PrivateData, STPTI_CarouselEntry_t Entry, U8 FromByte)
{
    ...
    STTBX_Print(("STPTI_CarouselInsertTimedEntry: CAROUSEL HANDLE 0x%08x CCVALUE 0x%08x INJTYPE 0x%08x CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselHandle,(U32)CCValue,(U32)InjectionType, (U32)Entry ));
    ...
    if (Error == ST_NO_ERROR)
    {
        ...
        if (LockingSession.word == STPTI_NullHandle() || LockingSession.word == CarouselHandle)
        {
                ...
                /* Either Carousel isn't locked, or locked by this session so OK to modify */
#if defined (ST_OSLINUX)
                /* Copy the TS packet to the carousel object as the data is currently on the stack and will not persist */
                memcpy( (void*)Entry_p->PacketData, TSPacket_p, sizeof(STPTI_TSPacket_t) );
                Entry_p->PacketData_p   = (U8*)Entry_p->PacketData;
#else
             ...
             /* Entry_p->FromByte       = FromByte; */
                ...
                if (Error == ST_NO_ERROR)
                {
                    ...
                    if (Error == ST_NO_ERROR)
                    {
                        ...
                        {
                            /* Signal only on first entry insertion */
                            STTBX_Print(("\nSignaling CarouselTask (from STPTI_CarouselInsertTimedEntry)\n"));
                            STOS_SemaphoreSignal (stptiMemGet_Carousel(FullCarouselHandle)->Sem_p);
                        }
                    }
                }
...
ST_ErrorCode_t STPTI_CarouselLock(STPTI_Carousel_t CarouselHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselLock: CAROUSEL HANDLE 0x%08x\n", (U32) CarouselHandle ));
...
ST_ErrorCode_t STPTI_CarouselGetCurrentEntry(STPTI_Carousel_t CarouselHandle, STPTI_CarouselEntry_t *Entry_p, U32 *PrivateData_p)
{
    ...
    STTBX_Print(("STPTI_CarouselGetCurrentEntry: CAROUSEL HANDLE 0x%08x\n", (U32) CarouselHandle ));
    ...
    STTBX_Print(("STPTI_CarouselGetCurrentEntry: CAROUSEL ENTRY HANDLE 0x%08x PRIVATEDATA 0x%08x\n", (U32) *Entry_p, *PrivateData_p ));
...
ST_ErrorCode_t STPTI_CarouselRemoveEntry(STPTI_Carousel_t CarouselHandle, STPTI_CarouselEntry_t Entry)
{
    ...
    STTBX_Print(("STPTI_CarouselRemoveEntry: CAROUSEL HANDLE 0x%08x CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselHandle, (U32) Entry ));
...
ST_ErrorCode_t STPTI_CarouselSetAllowOutput(STPTI_Carousel_t CarouselHandle, STPTI_AllowOutput_t OutputAllowed)
{
    ...
    STTBX_Print(("STPTI_CarouselSetAllowOutput: CAROUSEL HANDLE 0x%08x OUTPUTALLOCATE 0x%08x\n", (U32) CarouselHandle, (U32) OutputAllowed ));
...
ST_ErrorCode_t STPTI_CarouselSetBurstMode(STPTI_Carousel_t CarouselHandle, U32 PacketTimeMs, U32 CycleTimeMs)
{
    ...
    STTBX_Print(("STPTI_CarouselSetBurstMode: CAROUSEL HANDLE 0x%08x PACKET_TIME_MS 0x%08x CYCLE_TIME_MS 0x%08x\n", (U32) CarouselHandle, (U32) PacketTimeMs,(U32) CycleTimeMs ));
...
ST_ErrorCode_t STPTI_CarouselUnlinkBuffer(STPTI_Carousel_t CarouselHandle, STPTI_Buffer_t BufferHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselUnlinkBuffer: CAROUSEL HANDLE 0x%08x BUFFER HANDLE 0x%08x\n", (U32) CarouselHandle, (U32) BufferHandle ));
...
ST_ErrorCode_t STPTI_CarouselUnLock(STPTI_Carousel_t CarouselHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselUnLock: CAROUSEL HANDLE 0x%08x\n", (U32) CarouselHandle));
...
ST_ErrorCode_t STPTI_CarouselDeallocate(STPTI_Carousel_t CarouselHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselDeallocate: CAROUSEL HANDLE 0x%08x\n", (U32) CarouselHandle ));
...
ST_ErrorCode_t STPTI_CarouselEntryDeallocate(STPTI_CarouselEntry_t CarouselEntryHandle)
{
    ...
    STTBX_Print(("STPTI_CarouselEntryDeallocate: CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselEntryHandle ));
...
ST_ErrorCode_t STPTI_CarouselEntryLoad(STPTI_CarouselEntry_t CarouselEntryHandle, STPTI_TSPacket_t Packet, U8 FromByte)
{
    ...
    STTBX_Print(("STPTI_CarouselEntryLoad: CAROUSEL ENTRY HANDLE 0x%08x FROMBYTE 0x%02x\n", (U32) CarouselEntryHandle, (U32)FromByte ));
...
void stpti_CarouselUnlinkSimpleEntry(FullHandle_t CarouselHandle, FullHandle_t EntryHandle)
{
    ...
    STTBX_Print(("stpti_CarouselUnlinkSimpleEntry: CAROUSEL HANDLE 0x%08x CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselHandle.word, (U32)EntryHandle.word ));
...
void stpti_CarouselUnlinkTimedEntry(FullHandle_t CarouselHandle, FullHandle_t EntryHandle)
{
    ...
    STTBX_Print(("stpti_CarouselUnlinkTimedEntry: CAROUSEL HANDLE 0x%08x CAROUSEL ENTRY HANDLE 0x%08x\n", (U32) CarouselHandle.word, (U32)EntryHandle.word ));
...
static void stpti_SimpleCarouselTask(CarouselLaunchParams_t *CarouselLaunchParams_p)
{
    ...
    /* signal the parent that task */
    STOS_SemaphoreSignal(ReadCarouselParams_p);

    PacketsSent = 0;

    PTISessionNumber = (U16)(stptiMemGet_Device(CarouselHandle)->Session);
    ...
    {    
        ...
        {
            STOS_SemaphoreSignal(stpti_MemoryLock);
            STOS_TaskDelay(NextPacketDelay);
            NextPacketDelay = 0;
            STOS_SemaphoreWait(stpti_MemoryLock);
        }
        ...
        {        
            if (MissedSignals > 0)
            {
                STTBX_Print(("WARNING>> Missed Signals [%d]\n", MissedSignals));
                MissedSignals = 0;
            }
            ...
            {
                if (Carousel_p->CurrentEntry.word != STPTI_NullHandle())
                {
                    U16 PTISessionTCProcessing;

                    /* acquire TCCore access semaphore */
                    STOS_SemaphoreSignal(stpti_MemoryLock);
                    ...
                    /* read the current PTI session processed by TCCore */
                    PTISessionTCProcessing = \
                        (U16)((STSYS_ReadRegDev16LE((void*)&CarouselDataStart_p->CarouselControl) & TC_CAROUSEL_OUTPUT_PTI_SESSION) >> 2);

                    /* if TC is processing our previous upload, check the status of completion */
                    if (PTISessionTCProcessing == PTISessionNumber)
                    {
                        /* check whether the last entry loaded by this carousel is consumed by TC */
                        while( (STSYS_ReadRegDev16LE((void*)&CarouselDataStart_p->CarouselControl) & TC_CAROUSEL_ENTRY_READY) != 0)
                        {
                            STOS_SemaphoreSignal(stpti_MemoryLock);
                            STOS_TaskDelayUs(200); /* STOS_TaskYield();*/
                            STOS_SemaphoreWait(stpti_MemoryLock);
                        ...
                        {
                            /*    current entry = entry currently loaded in the carousel awaiting output, 
                                we got the signal from TC for the comsumption so reset CurrentEntry */
                            Carousel_p->CurrentEntry.word = STPTI_NullHandle();
                        }
                    }
                    else /* we lost our TC complete signal so clear the current entry */
                    {
                        Carousel_p->CurrentEntry.word = STPTI_NullHandle();
                    }
                    STOS_SemaphoreSignal(CarouselTCLockSem_p);
                ...
                /* wait for the new insert entry */
                STOS_SemaphoreSignal(stpti_MemoryLock);
                STOS_SemaphoreWait(Sem_p);
                STOS_SemaphoreWait(stpti_MemoryLock);

                /* Sem_p is signalled for abort, abort task run */
                Carousel_p = stptiMemGet_Carousel(CarouselHandle);
                if (Carousel_p->AbortFlag)
                {
                    break;
            ...
            else
            {
                ...
                /* ensure the previous entry loaded to TC Data RAM is consumed by TC core */
                while( (STSYS_ReadRegDev16LE((void*)&CarouselDataStart_p->CarouselControl) & TC_CAROUSEL_ENTRY_READY) != 0)
                {
                    STOS_SemaphoreSignal(stpti_MemoryLock);
                    STOS_TaskDelayUs(100); /* STOS_TaskYield();*/
                    STOS_SemaphoreWait(stpti_MemoryLock);
                ...
                if (!AbortFlag)
                {
                    ...
                    /* this carousel have the TC access semaphore, but wait if TC is reading previous entry loaded */
                    while(STSYS_ReadRegDev16LE((void*)&CarouselDataStart_p->TCReading) == TC_CAROUSEL_TC_READING)
                    {
                        STOS_SemaphoreSignal(stpti_MemoryLock);
                        STOS_TaskDelayUs(50); /* STOS_TaskYield(); */
                        STOS_SemaphoreWait(stpti_MemoryLock);
                    ...
                    if (!AbortFlag)
                    {
                        /* update TC, we are uploading the new entry data for next packet carousel */
                        ...
                        /* Load data into TC Data RAM - can't use memcpy 'cos it seems to be confused by device types */
                        for (i = 0; i < (DVB_TS_PACKET_LENGTH ) / sizeof(U32); ++i)
                        {
                            CarouselDataStart_p->CarouselData[i] = src_p[i]; 
                        }
                        
                        /* preserve the permanent bits in TC carousel control flags */
                        CarouselSetup &= TC_CAROUSEL_MASK_PERMANENT_FLAGS;
                        
                        /* update the details to TC for next carouseling */
                        CarouselSetup |= (U16)((Entry_p->FromByte << 8) | TC_CAROUSEL_ENTRY_READY | (PTISessionNumber << 2));
                        STSYS_WriteTCReg16LE((void*)&CarouselDataStart_p->CarouselControl, CarouselSetup);
                        ...
                        Carousel_p->UnlinkOnNextSem = (Entry_p->InjectionType == STPTI_INJECTION_TYPE_ONE_SHOT_INJECT) ? TRUE : FALSE;
                        ...
                        /* we should have a valid entry to proceed */
                        if (Carousel_p->StartEntry.word == STPTI_NullHandle() || \
                            Carousel_p->EndEntry.word == STPTI_NullHandle())
                        {
                            Carousel_p->NextEntry.word = STPTI_NullHandle();
                        }
                        else
                        {
        ...
        {
            /* carousel is locked for InsertEntry, so it is worth waiting here */
            STOS_SemaphoreSignal(stpti_MemoryLock);
            STOS_TaskDelayUs (300); /* STOS_TaskYield();*/
            STOS_SemaphoreWait(stpti_MemoryLock);
            MissedSignals++;
        }
...
static void stpti_TimedCarouselTask(CarouselLaunchParams_t *CarouselLaunchParams_p)
{
    ...
    while (!AbortFlag)
    {
            ...
            else
            {
                ...
                if (!AbortFlag)
                {
                    ...
                    if (!AbortFlag)
                    {
                        ...
                        /* update the details to TC for next carouseling */
                        CarouselSetup |= (U16)((Entry_p->FromByte << 8) | TC_CAROUSEL_ENTRY_READY | TC_CAROUSEL_TIMED_ENTRY | (PTISessionNumber<<2));
                        STSYS_WriteTCReg16LE((void*)&CarouselDataStart_p->CarouselControl, CarouselSetup);
        ...
        {
            /* carousel is locked for InsertEntry, so it is worth to wait here */
            STOS_SemaphoreSignal(stpti_MemoryLock);
            STOS_TaskDelayUs (300); /* STOS_TaskYield(); */
            STOS_SemaphoreWait(stpti_MemoryLock);
            MissedSignals++;
...
U32 stpti_CarouselGetPacketsSent(void)
{ 
    return PacketsSent;
}
