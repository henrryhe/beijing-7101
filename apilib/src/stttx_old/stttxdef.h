...
#if !defined(ST_5105) || !defined(ST_5188) || !defined(ST_5107)
#define POOLING_TASK_DIVIDER                150 /*For 5100,7100,7109*/
#else
...
#ifndef ST_OSLINUX
#define STTTX_HANDLER_TASK_PRIORITY         8/*cofigured through compilation flags*/
#else
#define STTTX_HANDLER_TASK_PRIORITY         65
#endif
#endif

#ifndef STTTX_POOLING_TASK_PRIORITY
#define STTTX_POOLING_TASK_PRIORITY         MAX_USER_PRIORITY /*cofigured through compilation flags*/
#endif
...
#ifndef STTTX_DISK_STACK_DEPTH
#ifdef ST_OS20
#define STTTX_DISK_STACK_DEPTH           ( 2048 )
#else
#define STTTX_DISK_STACK_DEPTH           (16*1024)
#endif
#endif

#ifndef STTTX_DMA_TIMEOUT_STACK_DEPTH
#ifdef ST_OS20
