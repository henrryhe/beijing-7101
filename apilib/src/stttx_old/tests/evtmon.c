...
#if defined(ST_5528) || defined (ST_5100) || defined (ST_7710) || defined (ST_7100) || defined(ST_5301) \
    || defined (ST_7109)
    /* Replaces STTSMUX */
#include "stmerge.h"
#endif
...
void GlobalInit(void)
{
    ...
    TTXEventSemaphore_p = STOS_SemaphoreCreateFifo(NULL, 0);
...
static ST_ErrorCode_t DEMUX_Init(void)
{
    ...
    InitParams.DemuxProcessPriority = 13 /*MIN_USER_PRIORITY*/;
