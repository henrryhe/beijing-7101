...
FE_288_SIGNALTYPE_t FE_288_CheckTiming( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params);
FE_288_SIGNALTYPE_t FE_288_CheckCarrier( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params);
FE_288_SIGNALTYPE_t FE_288_CheckData( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params);
void FE_288_IQInvertion( IOARCH_Handle_t IOHandle);
FE_288_SIGNALTYPE_t FE_288_SearchLock( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params);
FE_288_SIGNALTYPE_t FE_288_SearchData( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params);
...
void FE_288_Fine( IOARCH_Handle_t IOHandle,U32 MasterClock_Hz,U32 Symbolrate_Bds, BOOL TRY);
FE_288_SIGNALTYPE_t FE_288_Algo( IOARCH_Handle_t IOHandle,FE_288_InternalParams_t *Params, STTUNER_Handle_t TopLevelHandle);		/* Demod handle */
...
BOOL FE_288_Harmonic( IOARCH_Handle_t IOHandle, U32 MasterClock_Hz,U32 RfFrequency_Khz);
