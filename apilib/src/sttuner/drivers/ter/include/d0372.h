...
#ifndef __STTUNER_TER_D0372_H
#define __STTUNER_TER_D0372_H
...
typedef struct
{
    ...
    STTUNER_IOREG_DeviceMap_t 	DeviceMap;            /* stv372 VSB register map & data table */
    U32                         StandBy_Flag;   /*** To take care same Standby Mode doesnot
                                                   execute more than once ***/
 } D0372_InstanceData_t;
