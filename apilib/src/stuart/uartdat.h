...
typedef enum
{
    ...
    UART_ABORT_TX =   (1<<7),           /* For DMA abort status */
    UART_ABORT_RX =   (1<<8)            /* For DMA abort status */
...
struct UART_ControlBlock_s
{
...
#if defined(STUART_DMA_SUPPORT)
    U8                      *DMAReceiveBufferBase;
    U8                      *OrigDMAReceiveBufferBase;
    U32                     RXDMANodeBytesRemaining;
#endif
    U8                      *ReceivePut_p;
    U8                      *ReceiveGet_p;
    ...
    /*BOOL					DMAEnabled;*/
#if defined (STUART_DMA_SUPPORT)
    STFDMA_Node_t           *TXFDMANode_p; 
    STFDMA_Node_t           *RXFDMANode_p; 
    STFDMA_Node_t           *OriginalFDMANode_p[2];
    STFDMA_TransferGenericParams_t TXFDMAGenericTransferParams; 
    STFDMA_TransferGenericParams_t RXFDMAGenericTransferParams;
    STFDMA_TransferId_t     TXFDMATransferId; 
    STFDMA_TransferId_t     RXFDMATransferId;
    STFDMA_ChannelId_t      TXFDMAChannelId;
    STFDMA_ChannelId_t      RXFDMAChannelId;
    semaphore_t             *DMARXSemaphore_p;
    semaphore_t             *DMATXSemaphore_p;	
    semaphore_t             *DMARXRequestSemaphore_p;
    semaphore_t             *DMARXCompleteSemaphore_p;	
    task_t                  *DMAReadTask;
#endif
    U8                      StuffingValue;
