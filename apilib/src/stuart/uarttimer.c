...
#ifdef STTBX_PRINT
#include "sttbx.h"
#endif                     /* STAPI includes */
#include "stcommon.h"

#include "uarttimer.h"                  /* Private includes */
    ...
    for (;;)
    {
        ...
        do
        {
            ...
            else
            {
                ...
                Timer_p->TimeoutError =
                   STOS_SemaphoreWaitTimeOut(Timer_p->TimeoutSemaphore_p, &clk);
            }
