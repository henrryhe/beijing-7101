...
/*=============================================================================
  ...
  ===========================================================================*/
int stvid_ioctl_open(struct inode *node, struct file *filp)
{
    ...
    if (NULL == filp->private_data) {
        ...
        /* stvid_ioctl_NewNode() may deshedule - call must be reentrant */
        filp->private_data = stvid_ioctl_NewNode(minor);
        if (NULL == filp->private_data) {
...
/*=============================================================================
   ...
   stvid_ioctl_release   (close)

   This function can deschedule and MUST be reentrant.

  ===========================================================================*/
int stvid_ioctl_release(struct inode *node, struct file *filp)  /* close */
{
...
static stvid_ioctl_dev_t *table[16];
...
/*=============================================================================
  ...
  ===========================================================================*/
stvid_ioctl_dev_t *stvid_ioctl_NewNode(unsigned int id)
{
    /* Check valid id */
    ...
    down(&(stvid_ioctl_lock)); /* We can deshedule here !!! */
    ...
    if (NULL == table[id]) {
        ...
        table[id] = (stvid_ioctl_dev_t*)kmalloc(sizeof(stvid_ioctl_dev_t), GFP_KERNEL);
    ...
    up(&(stvid_ioctl_lock));  /* Release the global lock */
...
/*=============================================================================
  ...
  ===========================================================================*/
stvid_ioctl_dev_t *stvid_ioctl_GetNode(unsigned int id)
{
    /* Check valid id */
