...
#define USE_I_CACHE                 0   /* 0 or 1 */
#define USE_D_CACHE                 0   /* 0 or 1 */

/*
   If USE_CODE_IN_SRAM = 1, all dhrystone code is put in SRAM.
   If USE_DATA_IN_SRAM = 1, most of dhrystone data is put in SRAM (except a 10Kbyte array
   that is too big).
   If both USE_CODE_IN_SRAM = 1 and USE_DATA_IN_SRAM = 1, change in mb282.cfg the following
        memory  INTERNAL      0x80000140     ( 0xEC0 )               RAM
        memory  DCACHE        0x80001000     ( 0x800 )               RAM
   by
        memory  INTERNAL      0x80000140     ( 0x16C0 )              RAM
*/
#define USE_CODE_IN_SRAM            0   /* 0 or 1 */
#define USE_DATA_IN_SRAM            0   /* 0 or 1 */
...
/* Functions defined in drhy21a.c */
...
/* Functions defined in drhy21b.c */
extern void    Proc_6 (
