...
File name   : hvr_dis1.h

Description : Video display module HAL registers for omega 1 header file
...
#ifndef __DISPLAY_REGISTERS_OMEGA1_H
#define __DISPLAY_REGISTERS_OMEGA1_H
...
#define VID_LDP         0x3F  /* Video Load internal pointer [0] (on - FLY )    */
...
/* VID_TRF - Temporal reference (12-bit) ---------------------------------- */
...
#define VID_DCF_B2R_POL     0x0004 /* Active field parity                   */
#define VID_DCF_STP_DEC     0x0001 /* Prevent picture degradation in ZOut x4*/

#define VID_DCF_FPO         0x4000 /* Select field polarity to freeze (5508)*/
#define VID_DCF_FRM         0x0100 /* Enable display field (5508)           */
...
#endif /* #ifndef __DISPLAY_REGISTERS_OMEGA1_H */
