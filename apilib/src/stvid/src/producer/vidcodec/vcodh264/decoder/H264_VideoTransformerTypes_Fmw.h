...
{
    H264_NORMAL_DECODE,
    H264_DOWNGRADED_DECODE_LEVEL1,
    H264_DOWNGRADED_DECODE_LEVEL2
   /* TBC */
} H264_DecodingMode_t;
#endif /* MME < 3.0 */
...
#else /* MME < 3.0 */
    H264_PictureDescriptor_t     *PictureDescriptor_p;     /* Array of picture descriptor */
#endif /* MME < 3.0 */
...
#else /* MME < 3.0 */
    H264_ScalingList_t *ScalingList_p;
#endif /* MME < 3.0 */
...
#else /* MME < 3.0 */
    H264_SetGlobalParamSPS_t * H264SetGlobalParamSPS_p;   /* SPS for next picture */
    H264_SetGlobalParamPPS_t * H264SetGlobalParamPPS_p;   /* PPS for next picture */
#endif /* MME < 3.0 */
} H264_SetGlobalParam_t ;
