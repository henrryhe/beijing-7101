...
**
**  @par OWNER: Regis Sochard / Regis Sochard
**
...
*/
    ...
    #define MPEG2_MME_VERSION    42     /* Latest MME API version */
#endif
...
typedef enum
{
    ...
    /* Constant never used by the driver */
...
*/
#ifndef MME11                   /*This switch is used to update the changes for MME API 1.0*/
/*MME API < 0.7 */
typedef enum
{
	MPEG2_NORMAL_DECODE,
	MPEG2_DOWNGRADED_DECODE_LEVEL1,
	MPEG2_DOWNGRADED_DECODE_LEVEL2
   /* TBC */
} MPEG2_DecodingMode_t;
#else
/*MME API 1.0*/
...
typedef struct
{
 ...
 /*U32 Dummy_Word*/  /* inserted to make the MB descriptor size equal to the multiple of 8 bytes  */
} XcodeMPEG2_MBDescr_t;

typedef struct
{
 U32 PercentageOfFieldEncodedMBInPicture;
 XcodeMPEG2_MBDescr_t MBDescArray[0];
}Xcode_MPEG2H264_XcodeInfo_t ;
...
*/
#ifdef ST_transcoder
typedef Xcode_MPEG2H264_XcodeInfo_t *MPEG2_MBDescr_t;
#else
...
#ifndef MME11
	U8 *                 intra_quantiser_matrix_p;            /* used by the HW accelerator for Inverse
                                                               Quantisation process : array of 64 bytes */
	U8 *                 non_intra_quantiser_matrix_p;        /* used by the HW accelerators for Inverse
                                                               Quantisation process : array of 64 bytes */
	U8 *                 chroma_intra_quantiser_matrix_p;     /* used by the HW accelerator for Inverse
                                                               Quantisation process : array of 64 bytes */
	U8 *                 chroma_non_intra_quantiser_matrix_p; /* used by the HW accelerators for Inverse
                                                               Quantisation process : array of 64 bytes */
#else
