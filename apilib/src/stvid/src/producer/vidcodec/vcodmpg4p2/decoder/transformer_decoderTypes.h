...
#if (MPEG4P2_MME_VERSION==11)
#define MPEG4P2_MME_API_VERSION "1.1"
#else
#define MPEG4P2_MME_API_VERSION "1.0"
#endif /* MPEG4P2_MME_VERSION */
...
/*!!!BC: warning redefine the error types between DivX and MPEG4P2: action to be cleaned with FW team  */
typedef enum ERROR_CODES_T_
{
	...
	DIVX_HEADER_DAMAGED,
	DIVX_NEW_PRED_NOT_SUPPORTED,    
	DIVX_SCALABILITY_NOT_SUPPORTED,
	DIVX_VOP_SHAPE_NOT_SUPPORTED,
	DIVX_STATIC_SPRITE_NOT_SUPPORTED,
	DIVX_GMC_NOT_SUPPORTED,				
	DIVX_QPEL_NOT_SUPPORTED
}ERROR_CODES;

#define DIVX_NO_ERROR                       MPEG4P2_NO_ERROR			
#define DIVX_FIRMWARE_TIME_OUT_ENCOUNTERED	MPEG4P2_FIRMWARE_TIME_OUT_ENCOUNTERED/* Timeout in F/W */

typedef struct _DIVXVIDEODECODERETURNPARAMS_T_
	{
#if (MPEG4P2_MME_VERSION>=11)
	ERROR_CODES Errortype;
#endif /* MPEG3P2_MME_VERSION==11 */
