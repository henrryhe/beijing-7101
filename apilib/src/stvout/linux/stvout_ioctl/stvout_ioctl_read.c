...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t stvout_ioctl_read   (struct file *filp, char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;

    stvout_ioctl_dev_t *dev_p = (stvout_ioctl_dev_t*)filp->private_data;
...
/*=============================================================================
  ...
  ===========================================================================*/
ssize_t stvout_ioctl_write  (struct file *filp, const char *buffer, size_t size, loff_t *offset)
{
    int err = 0;
    int transfer_size;
    int remaining_size;
...
/*=============================================================================
   ...
   in the template driver and stvout_ioctl_lseek should not be added to the fops.

  ===========================================================================*/
int stvout_ioctl_flush  (struct file *filp)
{
    return (0);
}
...
/*=============================================================================
  ...
  ===========================================================================*/
loff_t  stvout_ioctl_lseek  (struct file *filp,  loff_t offset, int other)
{
    return (-ENOTTY);
}
 ...
 * These methods are called from stvout_ioctl_read() and stvout_ioctl_write()
