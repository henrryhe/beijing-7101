...
/*=============================================================================
  ...
  ===========================================================================*/
int stvtg_ioctl_open(struct inode *node, struct file *filp)
{
    ...
    if (NULL == filp->private_data) {
        ...
        /* stvtg_ioctl_NewNode() may deshedule - call must be reentrant */
        filp->private_data = stvtg_ioctl_NewNode(minor);
        if (NULL == filp->private_data) {
...
/*=============================================================================
   ...
   stvtg_ioctl_release   (close)

   This function can deschedule and MUST be reentrant.

  ===========================================================================*/
int stvtg_ioctl_release(struct inode *node, struct file *filp)  /* close */
{
...
static stvtg_ioctl_dev_t *table[16];
...
/*=============================================================================
  ...
  ===========================================================================*/
stvtg_ioctl_dev_t *stvtg_ioctl_NewNode(unsigned int id)
{
    /* Check valid id */
    ...
    down(&(stvtg_ioctl_lock)); /* We can deshedule here !!! */
    ...
    if (NULL == table[id]) {
        ...
        table[id] = (stvtg_ioctl_dev_t*)kmalloc(sizeof(stvtg_ioctl_dev_t), GFP_KERNEL);
    ...
    up(&(stvtg_ioctl_lock));  /* Release the global lock */
...
/*=============================================================================
  ...
  ===========================================================================*/
stvtg_ioctl_dev_t *stvtg_ioctl_GetNode(unsigned int id)
{
    /* Check valid id */
