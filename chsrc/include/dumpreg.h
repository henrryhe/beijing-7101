...
BOOL DUMPREG_ListReg(parse_t *pars_p, char *result_sym_p);
BOOL DUMPREG_Read(parse_t *pars_p, char *result_sym_p);
BOOL DUMPREG_Dump(parse_t *pars_p, char *result_sym_p);
BOOL DUMPREG_Write(parse_t *pars_p, char *result_sym_p);
