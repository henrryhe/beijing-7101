...
typedef struct
{
	FE_297e_SIGNALTYPE_t    SignalType;			/*	Type of founded signal */
	FE_297e_SpectInv_t    	SpectInversion;		/*	Spectrum inversion */
	U32                     Frequency_Khz;		/*	Channel frequency (KHz) */
	U32                     SymbolRate_Bds; 	/*	Symbol rate (Bds) */
	FE_297e_Modulation_t	Modulation;			/*	QAM size */
} FE_297e_InternalResults_t;

/*	Internal param structure */
typedef struct
{
	FE_297e_SIGNALTYPE_t State;
	...
	U32 	SweepRate_Hz;
	FE_297e_Modulation_t QAMSize;   /*	QAM Size */
	FE_297e_Monitor Monitor_results;/*	Monitorting counters */
	S32     DerotOffset_Hz;
	U32     IF;                     /* Tuner Intermediate Frequency (KHz) filled in tcdrv.c during tuner open */
	FE_297e_InternalResults_t Results;
}FE_297e_InternalParams_t;

	
extern S32 InRange(S32 x,S32 y,S32 z); 
...
**RETURN	::	2^n
*****************************************************/
extern long PowOfX(int X, int N);
...
**RETURN	::	log(n)
*****************************************************/
extern short DSPnormalize(long *arg, short maxnorm);


extern long MULT32X32(long a,long b);


extern long Log10Int(long logarg);
...
extern FE_297e_Error_t FE_297e_Repeater(BOOL State);
...
*****************************************************/
extern U32 FE_297e_GetMclkFreq(U32 ExtClk_Hz);
...
*****************************************************/
extern U32 FE_297e_GetADCFreq(U32 ExtClk_Hz);
...
**RETURN	::	DerotFreq_Hz
*****************************************************/
extern U32 FE_297e_SetDerotFreq(U32 AdcClk_Hz, U32 DerotFreq_Hz);
...
*****************************************************/
extern U32 FE_297e_GetDerotFreq( U32 AdcClk_Hz);
...
**RETURN	::	None
*****************************************************/
extern void FE_297e_SetIirAdjacentcoefficient( U32 MasterClk_Hz, U32 SymbolRate);
...
**RETURN	::	None
*****************************************************/
extern void FE_297e_SetAllPasscoefficient(U32 MasterClk_Hz, U32 SymbolRate);
...
*****************************************************/
extern U32 FE_297e_SetSymbolRate( U32 AdcClk_Hz,U32 MasterClk_Hz,U32 SymbolRate, FE_297e_Modulation_t QAMSize);
...
**RETURN	::	Symbol rate
*****************************************************/
extern U32 FE_297e_GetSymbolRate( U32 MasterClk_Hz);
...
**RETURN	::	Sweep rate
*****************************************************/
extern U32 FE_297e_SetSweepRate(U32 AdcClk_Hz,U32 SymbolRate_Bds,
...
**RETURN	::	Sweep range
*****************************************************/
extern S32 FE_297e_SetSweepRange(U32 AdcClk_Hz,U32 SymbolRate_Bds, S32 SearchRange_Hz);
...
**RETURN	::	QAM size
*****************************************************/
extern FE_297e_Modulation_t FE_297e_SetQamSize(U32 SearchFreq_Khz, FE_297e_Modulation_t QAMSize);


/**/
extern void FE_297e_GetWaitingTime(FE_297e_Modulation_t QAMSize, U32 SymbolRate_Bds,FE_297e_Monitor *Monitor_results);


/**/
extern void FE_297e_SaturationComputation(FE_297e_Monitor *Monitor_results);
...
**RETURN	::	None
*****************************************************/
extern void FE_297e_GetBERCount(FE_297e_Monitor *Monitor_results);


extern void FE_297e_OptimiseNByteAndGetBER(FE_297e_Modulation_t QAMSize,U32 SymbolRate_Bds,FE_297e_Monitor *Monitor_results);


/**/
extern void FE_297e_GetPacketsCount(FE_297e_Monitor *Monitor_results);
...
**RETURN	::	None
*****************************************************/
extern void FE_297e_GetErrorCount(FE_297e_Modulation_t QAMSize, U32 SymbolRate_Bds, FE_297e_Monitor *Monitor_results);


/*
Clears all the Counters
*/
extern void FE_297e_ClearCounters( FE_297e_Monitor *Monitor_results);


extern S32 FE_297e_GetRFLevel( void);
...
--***************************************************/
extern U32 FE_297e_GetCarrierToNoiseRatio_u32(FE_297e_Modulation_t QAMSize, U32 *rpui_SNR);
...
--***************************************************/
extern FE_297e_SIGNALTYPE_t FE_297e_Algo(FE_297e_InternalParams_t *Params);
...
--RETURN	::	Error (if any)
--***************************************************/
extern FE_297e_Error_t	FE_297e_Search(FE_297e_SearchParams_t *pSearch, FE_297e_SearchResult_t	*pResult);
...
--RETURN	::	Error (if any)
--***************************************************/
extern FE_297e_Error_t	FE_297e_GetSignalInfo(FE_297e_SignalInfo_t	*pInfo);
