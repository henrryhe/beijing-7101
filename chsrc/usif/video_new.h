...
#if/*def OSD_COLOR_TYPE_RGB16  RGB4444*/0

#define VIDEO_TEXTBK_COLOR  	0xF569
#define VIDEO_TEXT_COLOR  		0xF257
#else/*ARGB1555*/
...
extern int Lum_Convert(int luminance);
extern int Chr_Convert(int Chroma);
extern int Con_Convert(int contrast);
