...
Description : System-wide devices header file for the STi71XX.
...
#define ST71XX_LMU_INTERRUPT                  OS21_INTERRUPT_DISP_LMU
...
/* STFAE - Other interrupts */
#define ST71XX_CRYPTO_SEC_CP_INTERRUPT        OS21_INTERRUPT_CRYPTO_SEC_CP  
#define ST71XX_CRYPTO_DMA_FIN_INTERRUPT       OS21_INTERRUPT_CRYPTO_DMA_FIN 
#define ST71XX_CRYPTO_SIG_CHK_INTERRUPT       OS21_INTERRUPT_CRYPTO_SIG_CHK 
#define ST71XX_EXT_INT_ENC2_INTERRUPT         OS21_INTERRUPT_IRL_ENC_2        
#define ST71XX_EXT_INT_ENC7_INTERRUPT         OS21_INTERRUPT_IRL_ENC_7        
...
#define ST71XX_LMU_INTERRUPT                  153
...
/* LMI_SYS control registers */
#define ST71XX_LMI_CONFIG_BASE_ADDRESS        tlm_to_virtual(0xAF000000) /*LMI_SYS*/

/* actual memory window, as visible from ST40 P2 region and 176 MB address space */
...
/* actual memory window, as visible from ST40 P2 region and 112 MB address space */
...
/* STFAE - Add this delta base address */
#define ST71XX_DELTA_BASE_ADDRESS             tlm_to_virtual(0xB9214000)
